<div class="container px-[60px] max-lg:px-8 max-sm:px-4">
    <div class="flex items-start gap-10 max-lg:gap-5 md:mt-10">
        ...
        <div class="flex-1">
            ...
            @else
                <div class="mt-8 grid grid-cols-4 gap-6 max-1180:grid-cols-3 max-1060:grid-cols-2 max-md:mt-5 max-md:grid-cols-2 max-sm:grid-cols-2 max-md:justify-items-center max-md:gap-4 max-sm:gap-3">
