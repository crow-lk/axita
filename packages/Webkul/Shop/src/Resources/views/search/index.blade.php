...
<x-shop::layouts :has-feature="false">
    ...
    @pushOnce('scripts')
        ...
        >
            <div class="container px-[20px] max-lg:px-8 max-sm:px-4">
                <div class="flex flex-col gap-4 md:mt-10">
                    ...
                    <div class="flex-1">
                        ...
                        <div v-else>
                            <!-- Product Card Shimmer Effect -->
                            <template v-if="isLoading">
                                <div class="mt-8 grid grid-cols-4 gap-6 max-1180:grid-cols-3 max-1060:grid-cols-2 max-md:grid-cols-1 max-md:gap-x-4 max-sm:mt-5 max-sm:justify-items-center max-sm:gap-y-5">
                            ...
                            <template v-else>
                                <template v-if="products.length">
                                    <div class="mt-8 grid grid-cols-4 gap-6 max-1180:grid-cols-3 max-1060:grid-cols-2 max-md:grid-cols-1 max-md:mt-5 max-md:justify-items-center max-md:gap-x-4 max-md:gap-y-5">
                                        <x-shop::products.card
                                            ::mode="'grid'"
                                            v-for="product in products"
