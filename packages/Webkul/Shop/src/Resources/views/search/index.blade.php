...
<x-shop::layouts :has-feature="false">
    ...
    <div class="mx-auto mt-16 lg:mt-24 w-full max-w-[1350px] px-4 sm:px-6 lg:px-8">
    ...
    @pushOnce('scripts')
        ...
        >
            <div class="mx-auto mt-12 w-full max-w-[1350px] px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col gap-4 md:mt-10">
                    ...
                    <div class="flex-1">
                        ...
                        <div v-else>
                            <!-- Product Card Shimmer Effect -->
                            <template v-if="isLoading">
                                <div class="mt-8 grid grid-cols-4 gap-6 max-1180:grid-cols-3 max-1060:grid-cols-2 max-md:grid-cols-2 max-sm:grid-cols-2 max-md:gap-4 max-sm:mt-5">
                            ...
                            <template v-else>
                                <template v-if="products.length">
                                    <div class="mt-8 grid grid-cols-4 gap-6 max-1180:grid-cols-3 max-1060:grid-cols-2 max-md:grid-cols-2 max-sm:grid-cols-2 max-md:mt-5 max-md:gap-4">
                                        <x-shop::products.card
                                            ::mode="'grid'"
                                            v-for="product in products"
