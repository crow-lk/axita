...
return [
    ...
    [
        ...
        'key'    => 'sales.payment_methods.payzy',
        'name'   => 'admin::app.configuration.index.sales.payment-methods.payzy',
        'info'   => 'admin::app.configuration.index.sales.payment-methods.payzy-info',
        'sort'   => 3,
        'fields' => [
            [
                'name'          => 'title',
                ...
                'name'          => 'shop_id',
                'title'         => 'admin::app.configuration.index.sales.payment-methods.shop-id',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
                ...
                'title'         => 'admin::app.configuration.index.sales.payment-methods.payhere-merchant-id',
                'type'          => 'text',
                'channel_based' => true,
                'locale_based'  => false,
                'info'          => 'admin::app.configuration.index.sales.payment-methods.payhere-merchant-id-info',
            ], [
                'name'          => 'payhere_merchant_secret',
                'title'         => 'admin::app.configuration.index.sales.payment-methods.payhere-merchant-secret',
                'type'          => 'password',
                'channel_based' => true,
                'locale_based'  => false,
                'info'          => 'admin::app.configuration.index.sales.payment-methods.payhere-merchant-secret-info',
            ], [
                'name'          => 'sandbox',
        ...
        'name'   => 'admin::app.configuration.index.sales.payment-methods.koko',
        'info'   => 'admin::app.configuration.index.sales.payment-methods.koko-info',
        'sort'   => 4,
        'fields' => [
            [
                'name'          => 'title',
                ...
                'title'         => 'admin::app.configuration.index.sales.payment-methods.sandbox-api-url',
                'type'          => 'text',
                'info'          => 'admin::app.configuration.index.sales.payment-methods.sandbox-api-url-info',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'production_api_url',
                'title'         => 'admin::app.configuration.index.sales.payment-methods.production-api-url',
                'type'          => 'text',
                'info'          => 'admin::app.configuration.index.sales.payment-methods.production-api-url-info',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'instructions',
