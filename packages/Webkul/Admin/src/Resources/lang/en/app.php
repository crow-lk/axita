...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => 'Password',
            'powered-by-description' => 'Powered by Crow.lk',
            'submit-btn'             => 'Sign In',
            'title'                  => 'Sign In',
        ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'payhere-merchant-id-info'       => 'Optional: Enter your PayHere Merchant ID if you want to use PayHere as alternative payment provider',
                    'payhere-merchant-secret'        => 'PayHere Merchant Secret',
                    'payhere-merchant-secret-info'   => 'Optional: Enter your PayHere Merchant Secret for secure payment verification',
                    'payzy'                          => 'Payzy',
                    'payzy-info'                     => 'Payzy is a secure online payment gateway that enables businesses to accept payments via credit cards, debit cards, and other payment methods.',
                    'koko'                           => 'KOKO',
                    'koko-info'                      => 'KOKO lets customers split their purchase into three zero-interest instalments while you receive the full payment upfront.',
                    'pending'                        => 'Pending',
                    'pending-payment'                => 'Pending Payment',
                    'processing'                     => 'Processing',
                    'production-api-url'             => 'Production API URL',
                    'production-api-url-info'        => 'Set the live API endpoint provided by KOKO for creating payment sessions.',
                    'sandbox'                        => 'Sandbox',
                    'sandbox-api-url'                => 'Sandbox API URL',
                    'sandbox-api-url-info'           => 'Set the sandbox/testing API endpoint provided by KOKO for creating payment sessions.',
                    'secret-key'                     => 'Secret Key',
                    'shop-id'                        => 'Shop ID',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Powered by Crow.lk',
            ],
        ],
